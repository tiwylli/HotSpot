# This file is borrowed from IDR: https://github.com/lioryariv/idr
import torch
import torch.nn as nn
import spheretracer_utils.rend_util as rend_util
...
class RayTracing(nn.Module):
    ...
    def forward(self,
        ...
        curr_start_points, unfinished_mask_start, acc_start_dis, acc_end_dis, min_dis, max_dis, iters = \
    ...
    def sphere_tracing(self, batch_size, num_pixels, sdf, cam_loc, ray_directions, mask_intersect, sphere_intersections):
        ...
        iterations_per_ray = torch.zeros(batch_size * num_pixels, dtype=torch.int).cuda()
        ...
        while True:
            ...
            #iterations_per_ray[unfinished_mask_start | unfinished_mask_end] += 1
            iterations_per_ray[unfinished_mask_start] += 1
        ...
        return curr_start_points, unfinished_mask_start, acc_start_dis, acc_end_dis, min_dis, max_dis, iterations_per_ray
