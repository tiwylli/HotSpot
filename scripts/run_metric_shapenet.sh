...
EXP_DIR=/data_fast/SPIN/log/3D/ShapeNet/SIREN
CONFIG_DIR=$EXP_DIR/*.toml
GT_MESHES_DIR=/data_fast/SPIN/data/ShapeNetNSP-watertight-meshes
DATA_DIR=/data_fast/SPIN/data/NSP_dataset
RAW_DATA_DIR=/data_fast/SPIN/data/ShapeNetNSP
