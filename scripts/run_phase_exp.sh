...
IDENTIFIER='PHASE-bound-exp'                       # change to your desired identifier
ADDITIONAL_ARGS=$@

CONFIG_DIR=$ROOT_DIR'configs/phase_exp.toml' # Change to your config file path
...
for SHAPE_TYPE in 'phase_exp'; do
    # for coef in 0.1 0.2 0.3 0.5 1.0 5.0 10.0 20.0; do
