...
for SHAPE_TYPE in 'snowflake' 'button' 'target' 'bearing' 'snake' 'seaurchin' 'peace' 'boomerangs' 'fragments' 'house' 'circle' 'L' 'square' 'starhex'; do
# for SHAPE_TYPE in 'house'; do
    echo $SHAPE_TYPE
