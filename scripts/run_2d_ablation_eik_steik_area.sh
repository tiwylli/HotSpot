...
IDENTIFIER='eik_steik_area'                       # change to your desired identifier

CONFIG_DIR=$ROOT_DIR'configs/ablation_2d_eik_steik_area.toml' # Change to your config file path
