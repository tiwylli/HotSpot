...
LOG_DIR=$ROOT_DIR'log/3d_morepoints/'              # change to your desired log path
...
#for SHAPE_NAME in 'lamp' 'loudspeaker' 'bench' 'cabinet' 'sofa'  'rifle' 'table' 'telephone' 'watercraft' 'airplane'; do # use the shapes you want in the dataset
...
for SHAPE_NAME in 'loudspeaker'; do # use the shapes you want in the dataset
    ...
    #for FILE_NAME in 'd1b15263933da857784a45ea6efa1d77.ply' 'd217e8ab61670bbb433009863c91a425.ply' 'd16bb6b2f26084556acbef8d3bef8f28.ply' 'd284b73d5983b60f51f77a6d7299806.ply'; do # use the scans you want
    #for FILE_NAME in 'c9de3e18847044da47e2162b6089a53e.ply'; do # use the scans you want
    for FILE_NAME in 'cb3bc7b6610acb7d7f38a9bfed62447a.ply' 'c9de3e18847044da47e2162b6089a53e.ply'   ; do # use the scans you want
