...
IDENTIFIER='SPIN-flip5-test' # change to your desired identifier

CONFIG_DIR=$ROOT_DIR"configs/spin_shapenet0.toml" # change to your config file path
...
for SHAPE_NAME in 'loudspeaker'; do # use the shapes you want in the dataset
    ...
    # for FILE_NAME in 'd284b73d5983b60f51f77a6d7299806.ply' 'd1b15263933da857784a45ea6efa1d77.ply' 'd217e8ab61670bbb433009863c91a425.ply'; do # use the scans you want
    for FILE_NAME in 'cc6ebcef8d2e674690146e2a0489a257.ply'; do # use the scans you want
