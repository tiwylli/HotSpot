...
for SHAPE_TYPE in 'snowflake' 'circle' 'L' 'house' 'button' 'target' 'fragments'; do # for SHAPE_TYPE in 'circle' 'L' 'square' 'snowflake' 'starhex' 'button' 'target' 'bearing' 'snake' 'seaurchin' 'peace' 'boomerangs' 'fragments' 'house'; do
