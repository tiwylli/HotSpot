...
IDENTIFIER='StEik-2024-11-01-18-56-32' # change to your desired identifier

CONFIG_DIR=$ROOT_DIR"configs/steik_nie.toml" # change to your config file path
DATASET_DIR=$ROOT_DIR'data/NIE/point_cloud'    # change to your dataset path
LOG_DIR=$ROOT_DIR'log/3D/NIE/'                    # change to your desired log path
...
echo $SHAPE_NAME
for FILE_NAME in 'vbunny.ply'; do # use the scans you want
