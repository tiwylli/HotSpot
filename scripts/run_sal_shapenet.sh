...
IDENTIFIER='SAL-2024-10-20-15-22-38' # change to your desired identifier
...
for SHAPE_NAME in 'chair' 'display' 'lamp' 'loudspeaker' 'rifle' 'sofa' 'table' 'telephone' 'watercraft' ; do # use the shapes you want in the dataset
