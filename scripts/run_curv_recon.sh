...
for SHAPE_TYPE in 'circle' 'L' 'square' 'snowflake' 'starhex' 'button' 'target' 'bearing' 'snake' 'seaurchin' 'peace' 'boomerangs' 'fragments' 'house'; do # shapes: "circle", "L", "square", "snowflake", "starhex", "button", "target", "bearing", "snake", "seaurchin", "peace", "boomerangs", "fragments", "house"
