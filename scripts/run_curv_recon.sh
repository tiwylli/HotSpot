...
IDENTIFIER='curv_debug'                                                   # change to your desired identifier
LOG_DIR='./log/2d_curv/'                                           # change to your desired log path
mkdir -p $LOG_DIR

for SHAPE_TYPE in 'target' 'circle' 'L' 'square' 'snowflake' 'starhex' 'button'  'bearing' 'snake' 'seaurchin' 'peace' 'boomerangs' 'fragments' 'house'; do # for SHAPE_TYPE in 'circle' 'L' 'square' 'snowflake' 'starhex' 'button' 'target' 'bearing' 'snake' 'seaurchin' 'peace' 'boomerangs' 'fragments' 'house'; do
