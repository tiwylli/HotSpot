...
IDENTIFIER='PHASE-temp' # change to your desired identifier

CONFIG_DIR=$ROOT_DIR"configs/phase_shapenet.toml" # change to your config file path
...
for SHAPE_NAME in 'cabinet'; do # use the shapes you want in the dataset
    FOLDER_DIR=${DATASET_DIR}/$SHAPE_NAME/
    echo $SHAPE_NAME
    for FILE_NAME in "b0f329dc43af0fbd4da5feafe6f1c8fc.ply"; do # Iterate over all the files in the folder
