...
OUTDIR='./out/'
IDENTIFIER='heat_lambda8_newInitParam'
...
LOSS_WEIGHTS=(2e4 1e2 1e2 5e1 1e2 0 8e2) # sdf, inter, normal, eikonal, div, latent, heat
...
do
  LOGDIR=${LOGDIRNAME}${NONMNFLD_SAMPLE_TYPE}'_sampling_'${GRID_RES}'-'${TIMESTAMP}'/'${SHAPE}'/'
